...
import com.hungmanhnguyen.android.audiorecorder.screen.record.RecordFragmentDirections
//import java.io.File
...
//            saveCfgToFile()
            ...
            v.findNavController().navigate(SettingsFragmentDirections.actionSettingsFragmentToRecordFragment(a,b,c,d))
...
//    }
    ...
    private fun updateDesc() {
        ...
        val bitRate: Int = if (viewModel.audioCodec.value != 0) viewModel.bitRate.value!!
